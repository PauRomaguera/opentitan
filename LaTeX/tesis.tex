...
Immediately following reset, the processor begins execution at the assembly entry point \texttt{rom\_start.S}. This startup code performs minimal initialization and ends up calling the function \texttt{rom\_epmp\_init}. It is important to note that prior to this function's execution, critical resources such as eFlash and SRAM are not yet mapped by any PMP entry, though they remain unaccessible due to \texttt{MMWP}=1.
